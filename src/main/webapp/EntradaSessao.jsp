...
<head>
    ...
    <title>Entrada Sessão</title>
</head>
<body style="background-image: url('coffe.jpg');">
<h1 id="title">Maid Café - Sessão</h1>
<form action="ProcessamentoSessao.jsp" >
    <br><br>
    <fieldset>
        <legend>Pedido</legend>
        <label>Nome: </label><input type="text" name="txtNome">
        <br><br>
        <label>Celular: </label><input type="text" name="txtCelular">
        <br><br>
        <label>Cupom de desconto: </label><input type="text" name="txtCupom">
        <br><br>
        ...
        <textarea name="mensagem" id="" cols="10" rows="5"></textarea>
        <br><br>
